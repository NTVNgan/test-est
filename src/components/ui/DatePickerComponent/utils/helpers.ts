...
export const elementPositionInAncestor = (el: HTMLElement, ancestor: HTMLElement): ElementPosition => {
    let top = 0;
    let left = 0;
    do {
        top += el.offsetTop || 0;
...
export const onSpaceOrEnter = (event: KeyboardEvent, handler: EventHandlerNonNull) => {
