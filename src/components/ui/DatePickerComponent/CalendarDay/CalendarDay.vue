    ...
    computed: {
        ...
        dayContentClass() {
            return [
                ...
                this.day.attributes && this.day.attributes.length !== 0 ? 'vc-day-content-active' : '',
                // this.dateValue.start &&
                // (this.dateValue.end.toString() == this.day.date.toString() ||
                //     this.dateValue.start.toString() == this.day.date.toString())
                //     ? 'vc-day-content-range-active'
                //     : '',
            ];
        },
        dayContentStyle() {
    ...
    methods: {
        ...
        processHighlight(
            ...
            if (isDate || isComplex) {
                backgrounds.push({
                    key,
                    wrapperClass: 'vc-day-layer vc-day-box-center-center rounded-4p bg-primary-500',
                ...
                backgrounds.push({
                    key,
                    wrapperClass: 'vc-day-layer vc-day-box-center-center rounded-4p bg-primary-500',
                    class: ['vc-highlight', start.class, 'rounded-4p bg-primary-500'],
                    // style: start.style,
                });
                content.push({
                    key: `${key}-content`,
                ...
                backgrounds.push({
                    key,
                    wrapperClass: 'vc-day-layer vc-day-box-center-center rounded-4p bg-primary-500',
                    class: ['vc-highlight', end.class, 'rounded-4p bg-primary-500'],
                    // style: end.style,
                });
                content.push({
                    key: `${key}-content`,
                ...
                backgrounds.push({
                    ...
                    class: ['vc-highlight vc-highlight-base-middle', base.class, 'bg-primary-50'],
                    // style: base.style,
                });
                content.push({
                    key: `${key}-content`,
        ...
        refreshPopovers() {
            ...
            if (arrayHasItems(this.popovers)) {
                popoverEvents = getPopoverTriggerEvents(
                    defaults({ id: this.dayPopoverId, data: this.day, isRenderFn: true }, ...this.popovers),
                );
            }
